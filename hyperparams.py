...
class giga_Hyperparams: # giga
    ...
    doc_dict = sum_dict
    '''
    source_train = '/Users/user/Desktop/dataset/Gigasum/train/train.article.txt'
    target_train = '/Users/user/Desktop/dataset/Gigasum/train/train.title.txt'
    
    source_valid = '/Users/user/Desktop/dataset/Gigasum/train/valid.article.filter.txt'
    target_valid = '/Users/user/Desktop/dataset/Gigasum/train/valid.title.filter.txt'
    
    source_test = '//Users/user/Desktop/dataset/Gigasum/test/test.giga.txt'
    
    sum_dict = '/Users/user/Desktop/dataset/Gigasum/train/full_dict.txt'
    doc_dict = sum_dict
...
class Hyperparams: # for LCSTS char data
    ...
    source_train = '/Users/user/Desktop/dataset/LCSTS/LCSTS2.0 2/processed (char)/train_article.txt'
    target_train = '/Users/user/Desktop/dataset/LCSTS/LCSTS2.0 2/processed (char)/train_summary.txt'
    
    source_valid = '/Users/user/Desktop/dataset/LCSTS/LCSTS2.0 2/processed (char)/test_article.txt'
    target_valid = '/Users/user/Desktop/dataset/LCSTS/LCSTS2.0 2/processed (char)/test_summary.txt'
    
    source_test = '/Users/user/Desktop/dataset/LCSTS/LCSTS2.0 2/processed (char)/test_article.txt'
    
    sum_dict = '/Users/user/Desktop/dataset/LCSTS/LCSTS2.0 2/processed (char)/dict.txt'
    doc_dict = sum_dict
