...
class AttentionNode():
    '''used only for refer to attention tensor'''
    def __init__(self):
        self.enc_selfatten = None
        self.dec_selfatten = None
        self.vanilla_atten = None

class Graph():
    def __init__(self, is_training=True):
        self.graph = tf.Graph()
        self.atten_node = AttentionNode()
